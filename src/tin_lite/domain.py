...
PAID_ADS_ASSESSMENT_WORKFLOW_NAME = "growth.paid_ads_assessment"
PAID_ADS_LAUNCH_WORKFLOW_NAME = "growth.paid_ads_launch"
PAID_ADS_MONITOR_WORKFLOW_NAME = "growth.paid_ads_monitor"
